...
public class TestRunData {
	...
	public TestEntry getTest(TestClassName testClass, String testMethod) {
	...
	public static String nameOf(TestClassName testClass, String method) {
		return method + '(' + testClass.fqName() + ')';
	}

	public static String nameOf(TestClassName testClass) {
		return testClass.fqName();
	}
